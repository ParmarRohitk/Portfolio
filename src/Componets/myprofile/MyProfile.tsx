      ...
      <div className="profile" id="profile">
        <div className="profile-text">
          ...
          <p className="profile-text-about">
            Hello! I'm an MCA student specializing in Computer Science & IT,<br />
            with a strong focus on Full Stack Development and over a year of<br />
            coding experience. My expertise covers both frontend and backend<br />
